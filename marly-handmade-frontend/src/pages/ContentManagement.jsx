...
function ContentManagement() {
  const [aboutContent, setAboutContent] = useState({
    ...
    makerDescription: "Lorem ipsum dolor sit amet, consectetur adipiscing elit..."
  });
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ flex: 1, height: '4px', background: '#ddd', borderRadius: '2px' }}>
                  <div style={{ width: '30%', height: '100%', background: '#666', borderRadius: '2px' }}></div>
                </div>
              ...
              <h3 style={{ fontSize: '18px', margin: '20px 0 10px 0', color: '#333' }}>
                About MARLY's World
              </h3>
              ...
              <div style={{ display: 'flex', gap: '20px', marginBottom: '20px' }}>
                ...
                <div style={{ flex: 1 }}>
                  <h4 style={{ fontSize: '16px', margin: '0 0 10px 0', color: '#333' }}>Meet the Maker</h4>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '18px', margin: '20px 0', color: '#333', textAlign: 'center' }}>
                MARLY Collections
              </h3>
              ...
              <div style={{
                ...
                {collections.map((col) => (
                  <div key={col.id} style={{
                    ...
                    <div style={{ fontSize: '10px', color: '#999', marginTop: '5px' }}>{col.code}</div>
                  </div>
                ))}
              </div>
            </div>
